<?php $__env->startSection('content'); ?>
    <div class="card-body p-5">
        ...
        <hr>
        <form class="row g-3" method="POST" action="<?php echo e(route('order-update')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="col-md-6">
                ...
                <select id="inputProduct" class="form-select" name="product_id">
                    <option selected="" value="<?php echo e($order->product_id); ?>"><?php echo e($order->product->name); ?></option>
            ...
            <div class="col-md-4" id="exits_customer">
                ...
                <select class="form-control" id="exitCustomer" name="customer_id">
                    <option value="<?php echo e($order->customer->id); ?>"><?php echo e($order->customer->name); ?></option>
            ...
            <div id="new_customer" style="display: none">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="inputPhone" name="customer_phone" value="<?php echo e($order->phone); ?>">
                </div>
            </div>
            <div class="col-md-6">
                <label for="inputNotes" class="form-label">Notes</label>
                <input type="text" class="form-control" id="inputNotes"  name="notes" value="<?php echo e($order->notes); ?>">
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\localhost\htdocs\online_helper\resources\views/orders/edit.blade.php ENDPATH**/ ?>