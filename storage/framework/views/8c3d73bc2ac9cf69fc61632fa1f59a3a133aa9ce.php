<?php $__env->startSection('content'); ?>
    <div class="card-body p-5">
        ...
        <hr>
        <div class="card-body">
        <form class="row g-3" method="POST" action="<?php echo e(route('product-add')); ?>">
            <?php echo csrf_field(); ?>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="inputAmount"  name="amount" value="<?php echo e(old('amount')); ?>">
            </div>
            <div class="col-md-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\localhost\htdocs\online_helper\resources\views/products/new.blade.php ENDPATH**/ ?>